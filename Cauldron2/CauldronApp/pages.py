# The original code of this file can be found at https://www.technovelty.org/web/skipping-pages-with-djangocorepaginator.html
...
class Pages:
    ...
    def pages_to_show(self, page):
        ...
        #  - first page always
        #  - three pages before selected page
        #  - the selected page
        #  - three pages after selected page
        #  - last page always
        #
